...
public class ProcedureAllahsDaggerEntitySwingsItem extends ElementsAllahsRevengeMod.ModElement {
	public ProcedureAllahsDaggerEntitySwingsItem(ElementsAllahsRevengeMod instance) {
		super(instance, 3);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure AllahsDaggerEntitySwingsItem!");
			return;
		}
